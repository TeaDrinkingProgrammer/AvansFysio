...
namespace Portal.Tests {
    public class MaximumAppointmentsTest {
        [Fact]
        public void Edit_Appointment_Should_Return_Error_When_Exceeding_Maximum_Amount_Of_Appointments() {
            //Arrange
            ...
            var dateTime = DateTime.Now + new TimeSpan(11, 00, 00);
            ...
            Assert.Equal($"Afspraak overschrijdt 2 behandelingen in een week", result.ViewData.ModelState["Date"].Errors.First().ErrorMessage);
        }
    }
}
